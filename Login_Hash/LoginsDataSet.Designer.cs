...
namespace Login_Hash {
    ...
    public partial class LoginsDataSet : global::System.Data.DataSet {
        ...
        public partial class AcessosDataTable : global::System.Data.TypedTableBase<AcessosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AcessosRow AddAcessosRow(int id, string usuario, string email, string senha) {
...
namespace Login_Hash.LoginsDataSetTableAdapters {
    ...
    public partial class AcessosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Acessos] WHERE (([id] = @Original_id) AND ((@IsNull_usuario = 1 AND [usuario] IS NULL) OR ([usuario] = @Original_usuario)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_senha = 1 AND [senha] IS NULL) OR ([senha] = @Original_senha)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Acessos] ([id], [usuario], [email], [senha]) VALUES (@id, @usu" +
                "ario, @email, @senha);\r\nSELECT id, usuario, email, senha FROM Acessos WHERE (id " +
                "= @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Acessos] SET [id] = @id, [usuario] = @usuario, [email] = @email, [senha] = @senha WHERE (([id] = @Original_id) AND ((@IsNull_usuario = 1 AND [usuario] IS NULL) OR ([usuario] = @Original_usuario)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_senha = 1 AND [senha] IS NULL) OR ([senha] = @Original_senha)));
SELECT id, usuario, email, senha FROM Acessos WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Login_Hash.Properties.Settings.Default.Entrar_sdfConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, usuario, email, senha FROM dbo.Acessos";
        ...
        public virtual int Fill(LoginsDataSet.AcessosDataTable dataTable) {
        ...
        public virtual LoginsDataSet.AcessosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginsDataSet.AcessosDataTable dataTable = new LoginsDataSet.AcessosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginsDataSet.AcessosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_usuario, string Original_email, string Original_senha) {
        ...
        public virtual int Insert(int id, string usuario, string email, string senha) {
        ...
        public virtual int Update(int id, string usuario, string email, string senha, int Original_id, string Original_usuario, string Original_email, string Original_senha) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string usuario, string email, string senha, int Original_id, string Original_usuario, string Original_email, string Original_senha) {
            return this.Update(Original_id, usuario, email, senha, Original_id, Original_usuario, Original_email, Original_senha);
        }
    }
